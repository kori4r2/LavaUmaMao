...
namespace LavaUmaMao.Editor {
    public static class CustomBuilders {
        public static void BuildWebGL() {
            string[] arguments = Environment.GetCommandLineArgs();
            int index = Array.IndexOf(arguments, "LavaUmaMao.Editor.CustomBuilders.BuildWebGL");
        ...
        public static void BuildAndroid() {
            string[] arguments = Environment.GetCommandLineArgs();
            int index = Array.IndexOf(arguments, "LavaUmaMao.Editor.CustomBuilders.BuildAndroid");
            if (index < 0 || index >= arguments.Length - 1) {
